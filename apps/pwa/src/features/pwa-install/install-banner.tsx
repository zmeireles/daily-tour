...
export function InstallBanner() {
  ...
  return (
    <div
      role="region"
      aria-label={t("pwa_install.title", { defaultValue: "Install Daily Tour" })}
    ...
    >
      <div className="flex flex-col">
        <span className="text-sm font-semibold text-[#2F5D43]">
          {t("pwa_install.title", { defaultValue: "Install Daily Tour" })}
        </span>
        <span className="text-xs text-gray-600">
          {t("pwa_install.body", {
            defaultValue: "Add to your home screen for instant access.",
          })}
        </span>
      </div>
      <div className="flex shrink-0 gap-2">
        ...
        >
          {t("pwa_install.dismiss", { defaultValue: "Not now" })}
        </button>
        <button
          type="button"
