...
`notif_svc/main.py` and the shared suite stays green while this service serves every
...
from notif_svc.main import create_app

GUARDED = "/v1/notify/post-stay"
INTERNAL_HEADERS = {"x-internal-token": os.environ["NOTIF_SVC_INTERNAL_TOKEN"]}
